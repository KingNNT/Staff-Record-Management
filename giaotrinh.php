...
<div class="containerTailieu">
        <div class="container">
            <h2>
                <span style="font-weight: bold;color: green;">Giáo trình</span>
            </h2>
                        ...
                        <?php
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<script> 
                                                ...
                                                window.location.href='giaotrinh.php';
                                             </script>";
                                    }
                        ...
                        if (isset($_GET['del'])) {
                            ...
                            if (mysqli_affected_rows($conn) > 0) {
                                    ...
                                    if(file_exists( $filename))
                                    {
                                        ...
                                        window.location.href='giaotrinh.php';</script>";
                                        
                                    }
                                    else
                                    echo "<script>alert('Không tồn tại file!'); window.location.href='giaotrinh.php';</script>";   
                            }
                            else {
                                echo "<script>alert('Tài liệu này thuộc quyền của giáo viên khác!'); window.location.href='giaotrinh.php';</script>";   
                            }
                        }
                        ?>