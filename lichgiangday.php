...
<div class="containerTailieu">
        <div class="container">
            <h2>
                <span style="font-weight: bold;color: green;">Lịch giảng dạy</span>
            </h2>
            <form style="margin-bottom:50px;text-align:center;" action="" method="GET">
                ...
                <input class="btnUpload" type="submit" value="Tìm" name="timkiem">
                        ...
                        <?php 
                            ...
                            and loaitailieu ='Lịch giảng dạy'
                        ...
                        <?php
                                    ...
                                    else
                                    {
                                        ...
                                        echo "<script> 
                                                ...
                                                window.location.href='lichgiangday.php';
                                             </script>";
                                    }
                        ...
                        if (isset($_GET['del'])) {
                            ...
                            if (mysqli_affected_rows($conn) > 0) {
                                    ...
                                    if(file_exists( $filename))
                                    {
                                        ...
                                        window.location.href='lichgiangday.php';</script>";
                                        
                                    }
                                    else
                                    echo "<script>alert('Không tồn tại file!'); window.location.href='lichgiangday.php';</script>";   
                            }
                            else {
                                echo "<script>alert('Tài liệu này thuộc quyền của giáo viên khác!'); window.location.href='lichgiangday.php';</script>";   
                            }
                        }
                        ?>